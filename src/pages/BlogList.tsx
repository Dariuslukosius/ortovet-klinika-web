...
export default function BlogList() {
  ...
  const blogSchema = {
    ...
    "@type": "CollectionPage",
    name: "Ortovet blogas",
    description: "Naudingi veterinariniai straipsniai augintinių šeimininkams.",
  ...
  return (
    <main id="main-content">
      <Seo
        title="Veterinarijos blogas | Patarimai augintinių šeimininkams"
        description="Ortovet veterinarijos blogas apie augintinių sveikatą, vakcinaciją, diagnostiką, ortopediją, dantų priežiūrą ir kasdienę profilaktiką."
        jsonLd={[
